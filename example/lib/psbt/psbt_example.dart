...
void main() async {
  ...
  final btcAddress15 =
      P2shAddress.fromRedeemScript(script: Script(script: [BitcoinOpcode.opTrue]));
  final btcAddress16 =
      P2wshAddress.fromRedeemScript(script: Script(script: [BitcoinOpcode.opTrue]));
  final btcAddress17 = P2shAddress.fromRedeemScript(
...
(BitcoinBaseAddress, BitcoinBaseAddress, Script, List<int>) _getOpHash160() {
  ...
  final p2sh = P2shAddress.fromRedeemScript(script: script);
