...
class ElectrumRequestMasternodeAnnounceBroadcast extends ElectrumRequest<bool, bool> {
  ElectrumRequestMasternodeAnnounceBroadcast({required this.signmnb});
  final String signmnb;

  /// masternode.announce.broadcast
  @override
  String get method => ElectrumRequestMethods.masternodeAnnounceBroadcast.method;
