...
void main() {
  group('TestCreateP2trWithSingleTapScript', () {
    ...
    setUp(() {
      ...
      fromAddress2 = fromPub2.toTaprootAddress(treeScript: TaprootLeaf(script: trScriptP2pk1));
      txIn2 = TxInput(
    ...
    test('address_with_script_path', () {
      final toAddress = toPub1.toTaprootAddress(treeScript: TaprootLeaf(script: trScriptP2pk1));
  ...
  group('TestCreateP2trWithTwoTapScripts', () {
    ...
    late final fromAddress = fromPub.toTaprootAddress(
      treeScript: TaprootBranch(
          a: TaprootLeaf(script: trScriptP2pkA), b: TaprootLeaf(script: trScriptP2pkB)),
    );
  ...
  group('TestCreateP2trWithThreeTapScripts', () {
    ...
    final fromAddress = fromPub.toTaprootAddress(
      treeScript: TaprootBranch(
          a: TaprootBranch(
              b: TaprootLeaf(script: trScriptP2pkA), a: TaprootLeaf(script: trScriptP2pkB)),
