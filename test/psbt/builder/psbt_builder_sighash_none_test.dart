...
void _partialSignSighashNone(String psbt, List<Map<String, dynamic>> utxoes) {
  ...
  builder.signInput(signer: (params) => PsbtSignerResponse(signers: [key14]), index: 14);
    ...
    onFinalizeInput: (params) {
      if (params.inputData.taprootLeafScript != null &&
        ...
        return PsbtFinalizeResponse(
            tapleafHash: BytesUtils.tryFromHexString(utxoes[params.index]["select_leaf"]));
      }
      return null;
    },
  );

  expect(tx.txId(), "d95bf1d6a34dadcd458368f19c667f588b59b5c2217190433eb4c737575866c3");
}
