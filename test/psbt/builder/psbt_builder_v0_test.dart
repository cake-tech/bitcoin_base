...
void _test1() {
  test("PSBT", () {
    void checkBuilder(PsbtBuilderV0 builder) {
      ...
      expect(inputs.first.txId, "0a4217b239c54c1d46edf2042b7546a5f9c0ac60a0f7d4b72787586fe4c3ffbe");
    ...
    final fee = BtcUtils.toSatoshi("0.0001");
    final changeAmount = totalAmount - (rec1Amount + fee);
    builder.addOutput(PsbtTransactionOutput(amount: rec1Amount, address: receipt2));
    builder.addOutput(PsbtTransactionOutput(amount: changeAmount, address: receipt1));
    ...
    expect(() {
      ...
      final privateKey =
          ECPrivate.fromHex("39d9f93498ab9c5e833b6e22493be2aaa8d4daabb141afac801fccbf1298cd05");
      clone.signInput(
          signer: (p0) {
...
void _addP2shAddress(PsbtBuilder builder) {
  ...
  final p2shSigner = P2shAddress.fromAddress(
      address: "2N3oneRSj5C4jUWsSFmAkY6FX45kW7tUUP5", network: BitcoinNetwork.testnet);
  ...
  expect(() {
    ...
    expect(
        ...
        throwsA(isA<DartBitcoinPluginException>()));
    final p2shSigner =
        ECPrivate.fromHex("33053373fe566dc4f77941a449c20dfa356221dfadec5e3d507c58279e0e1991");
    clone.signInput(
        signer: (p0) {
  ...
  expect(() {
    ...
    expect(() {
      ...
      clone.signInput(
          ...
          index: 0);
      clone.addOutput(PsbtTransactionOutput(amount: BigInt.from(10000), address: _getReceipt3()));
    }, throwsA(isA<DartBitcoinPluginException>()));
...
Bip32Slip10Secp256k1 getMasterKey(
  ...
  Bip32Slip10Secp256k1 masterKey =
